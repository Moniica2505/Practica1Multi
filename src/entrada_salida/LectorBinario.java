...
public final class LectorBinario {
    ...
    private int buffer;          // Variable tipo int para almacenar la 
    							 // palabra de 8 bits leida. 
    
    private int numBitsOcupados; // Numero de bits ocupados en el buffer.
    ...
    /**
     * Lee la proxima palabra de 8 bits en el archivo de entrada.
     *
     * @return Devuelve la palabra de 8 bits.
     * @throws RuntimeException si el flujo de entrada queda vacio.
     */
    public char leerPalabra() {
        ...
        // Se combinan los ultimos n bits del buffer actual con los primeros 8-n  
    ...
    /**
     * Lee el proximo bit en el archivo de entrada y lo devuelve como booleano.
     *
     * @return Devuelve el proximo bit como booleano.
     * @throws RuntimeException si se alcanza el final del archivo de entrada.
     */
    ...
    /**
     * Lee la proxima palabra de 32 bits en el archivo de entrada.
     *
     * @return la proxima palabra de 32 bits como int.
